...
<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>Историческая застройка центра Тромсё (Автор фотоснимка — Илья Варламов)</p></figcaption></figure>

Современная застройка максимально ориентирована на пользователя: доступность для пешеходов, навигация, освещение, инфраструктура пешеходной мобильности, т.к. велостойки, представляют собой отражение вышеописанной градостроительной доктрины территории.
